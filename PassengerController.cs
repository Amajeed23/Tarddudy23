...
namespace FirstAttempt.Controllers
{
    public class PassengerController : Controller
    {
        ...
        {
            SqlConnection conn = new SqlConnection("Data Source=SQL5110.site4now.net,1433;Initial Catalog=db_a9a03a_abdulmajeed;User Id=db_a9a03a_abdulmajeed_admin;Password=Am098ww123;");
            string sql;
        ...
        public async Task<IActionResult> Home()
        {
            ...
            ViewBag.Message = HttpContext.Session.GetString("pname");
        ...
        public async Task<IActionResult> DelAcc(string DelAcc)
        {
            ...
            {
                return RedirectToAction("DelAcc", new { passid = passengerToUpdate.PassID });
            }
