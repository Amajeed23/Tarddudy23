...
namespace FirstAttempt.Controllers
{
	public class HomeController : Controller
	{
		...
		public async Task<IActionResult> login(string na, string pa)
		{
			...
			// Passenger 
			SqlConnection conn2 = new SqlConnection("Data Source=SQL5110.site4now.net,1433;Initial Catalog=db_a9a03a_abdulmajeed;User Id=db_a9a03a_abdulmajeed_admin;Password=Am098ww123;");
			string sql1;
			...
			if (reader.Read())
			{
				...
				HttpContext.Session.SetString("pname", na);
				HttpContext.Session.SetString("passid", id);
				reader.Close();
				conn2.Close();
			...
			reader.Close();
			conn2.Close();
            SqlConnection conn1 = new SqlConnection("Data Source=SQL5110.site4now.net,1433;Initial Catalog=db_a9a03a_abdulmajeed;User Id=db_a9a03a_abdulmajeed_admin;Password=Am098ww123;");
			...
			if (reader1.Read())
			{
				...
				HttpContext.Session.SetString("dname", na);
				HttpContext.Session.SetString("driid", id);
				reader1.Close();
				conn1.Close();
				string sql4;
					sql4 = "SELECT BusID From Bus Where DriID = '"+ id +"'";
					SqlConnection conn4 = new SqlConnection("Data Source=SQL5110.site4now.net,1433;Initial Catalog=db_a9a03a_abdulmajeed;User Id=db_a9a03a_abdulmajeed_admin;Password=Am098ww123;");
			...
			reader1.Close();
			conn1.Close();
			SqlConnection conn3 = new SqlConnection("Data Source=SQL5110.site4now.net,1433;Initial Catalog=db_a9a03a_abdulmajeed;User Id=db_a9a03a_abdulmajeed_admin;Password=Am098ww123;");
			string sql2;
			...
			if (reader2.Read())
			{
				...
				HttpContext.Session.SetString("aname", na);
		...
		{
			int PassID = Convert.ToInt32(HttpContext.Session.GetString("passid"));
			if (PassID == 0)
			{
        ...
        public ActionResult Logout()
        {
            ...
            HttpContext.Session.Remove("passid");
            HttpContext.Session.Remove("pname");
            dynamic dynamicObject = ViewBag.DynamicObject;
        ...
        public ActionResult LogoutD()
        {
            ...
            HttpContext.Session.Remove("driid");
            HttpContext.Session.Remove("dname");
            dynamic dynamicObject = ViewBag.DynamicObject;
